...
#if !defined(__STANDALONE_MT76_TRACE_H) || defined(TRACE_HEADER_MULTI_READ)
#define __STANDALONE_MT76_TRACE_H

#include <linux/tracepoint.h>
#include "standalone_mt76.h"

#undef TRACE_SYSTEM
#define TRACE_SYSTEM standalone_mt76
...
TRACE_EVENT(dev_irq,
	TP_PROTO(struct standalone_mt76_dev *dev, u32 val, u32 mask),
...
DECLARE_EVENT_CLASS(dev_txid_evt,
	TP_PROTO(struct standalone_mt76_dev *dev, u8 wcid, u8 pktid),
